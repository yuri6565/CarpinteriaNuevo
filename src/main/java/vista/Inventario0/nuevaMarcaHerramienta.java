 ...
 * @author ZenBook
 */
public class nuevaMarcaHerramienta extends javax.swing.JDialog {

    private boolean guardado = false; // Indica si se presionó "Guardar"

    /**
     * Creates new form nuevaMarcaHerramienta
     */
    public nuevaMarcaHerramienta(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(nuevaMarcaHerramienta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
