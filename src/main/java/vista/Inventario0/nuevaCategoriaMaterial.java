 ...
 * @author ZenBook
 */
public class nuevaCategoriaMaterial extends javax.swing.JDialog {

    private boolean guardado = false; // Indica si se presionó "Guardar"

    /**
     * Creates new form nuevaCategoriaMaterial
     */
    public nuevaCategoriaMaterial(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(nuevaCategoriaMaterial.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
