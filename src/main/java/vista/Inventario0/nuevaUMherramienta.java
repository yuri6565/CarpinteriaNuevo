 ...
 * @author ZenBook
 */
public class nuevaUMherramienta extends javax.swing.JDialog {

    private boolean guardado = false; // Indica si se presionó "Guardar"

    /**
     * Creates new form nuevaUMherramienta
     */
    public nuevaUMherramienta(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (!nombre.isEmpty()) {
            ...
            if (dao.insertar(categoria)) {
                JOptionPane.showMessageDialog(this, "Unidad de medida añadida correctamente.");
                txtNombre.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(nuevaUMherramienta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
