 ...
 * @author EQUIPO
 */
public class Error_eliminar extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Error_eliminar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
