 ...
 * @author LENOVO
 */
public class MaterialvalorValida extends JDialog {

    /**
     * Creates new form MaterialPrecioNega
     */
    public MaterialvalorValida(Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jLabel2.setFont(new java.awt.Font("Century751 BT", 1, 30)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Error de Valores Ingresados");
        ...
        jLabel3.setText("(Use comas para decimales)");
        ...
        jLabel4.setText("Solo se permiten numeros enteros y decimales ");
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jEImagePanel2, javax.swing.GroupLayout.DEFAULT_SIZE, 557, Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jEImagePanel2, javax.swing.GroupLayout.DEFAULT_SIZE, 302, Short.MAX_VALUE)
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MaterialvalorValida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MaterialvalorValida dialog = new MaterialvalorValida(new javax.swing.JFrame(), true);
