...
public class alertaEliminarcategoria111 extends JDialog {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("¿Está seguro que desea eliminar esta categoría?");
...
public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(alertaEliminarcategoria111.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }

        java.awt.EventQueue.invokeLater(() -> {
            alertaEliminarcategoria111 dialog = new alertaEliminarcategoria111(new javax.swing.JFrame(), true, "¿Estás seguro?", "¿Está seguro que desea eliminar este producto?", "/warning-triangle-sign-free-vector-removebg-preview.png");
