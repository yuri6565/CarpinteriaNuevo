 ...
 * @author LENOVO
 */
public class AlertaNopuedeserVacio extends JDialog {

    /**
     * Creates new form AlertaNoVacio
     */
    public AlertaNopuedeserVacio(Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("El espacio no puede estar vacio");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlertaNopuedeserVacio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AlertaNopuedeserVacio dialog = new AlertaNopuedeserVacio(new javax.swing.JFrame(), true);
