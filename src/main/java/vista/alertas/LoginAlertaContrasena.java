 ...
 * @author EQUIPO
 */
public class LoginAlertaContrasena extends javax.swing.JDialog {
    

    /**
     * Creates new form espacio_alertga
     */
    public LoginAlertaContrasena(Frame parent, boolean modal, String error, String todos_los_campos_son_obligatorios) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Error,  Ingrese porfavor su contraseña");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginAlertaContrasena.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LoginAlertaContrasena dialog = new LoginAlertaContrasena(new javax.swing.JFrame(), true, "Error", "Todos los campos son obligatorios");
