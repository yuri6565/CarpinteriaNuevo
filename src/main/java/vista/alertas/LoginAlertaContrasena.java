 ...
 * @author EQUIPO
 */
public class LoginAlertaContrasena extends JDialog {

    public LoginAlertaContrasena() {
        if (!isVisible()) {
            initComponents();
            setOpacity(0.0f);
  ...
  // Agregar KeyListener para detectar la tecla Enter
    ...
    public LoginAlertaContrasena(Frame parent, boolean isEmpty) {
...
public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            LoginAlertaContrasena dialog = new LoginAlertaContrasena();
