 ...
 * @author LENOVO
 */
public class MaterialAlerPrecio extends JDialog {

    /**
     * Creates new form MaterialAlerPrecio
     */
    public MaterialAlerPrecio(Frame parent, boolean modal) {
       super(parent, modal);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Ingrese un numero valido en el precio");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MaterialAlerPrecio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MaterialAlerPrecio dialog = new MaterialAlerPrecio(new javax.swing.JFrame(), true);
