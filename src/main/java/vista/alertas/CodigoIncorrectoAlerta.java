 ...
 * @author EQUIPO
 */
public class CodigoIncorrectoAlerta extends javax.swing.JDialog {
    

    /**
     * Creates new form espacio_alertga
     */
    public CodigoIncorrectoAlerta(Frame parent, boolean modal, String error, String todos_los_campos_son_obligatorios) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Error,  el codigo ingresado es incorrecto, intenta de nuevo");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CodigoIncorrectoAlerta dialog = new CodigoIncorrectoAlerta(new javax.swing.JFrame(), true, "Error", "Todos los campos son obligatorios");
