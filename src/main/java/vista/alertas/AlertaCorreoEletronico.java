 ...
 * @author EQUIPO
 */
public class AlertaCorreoEletronico extends javax.swing.JDialog {
    

    /**
     * Creates new form espacio_alertga
     */
    public AlertaCorreoEletronico(Frame parent, boolean modal, String error, String todos_los_campos_son_obligatorios) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlertaCorreoEletronico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AlertaCorreoEletronico dialog = new AlertaCorreoEletronico(new javax.swing.JFrame(), true, "Error", "Todos los campos son obligatorios");
