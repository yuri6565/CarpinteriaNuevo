 ...
 * @author LENOVO
 */
public class MaterialAlertaCategoria extends JDialog {

    /**
     * Creates new form MaterialCategoria
     */
    public MaterialAlertaCategoria(Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Porfavor, Seleccione una categoria");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MaterialAlertaCategoria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MaterialAlertaCategoria dialog = new MaterialAlertaCategoria(new javax.swing.JFrame(), true);
