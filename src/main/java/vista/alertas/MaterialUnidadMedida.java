 ...
 * @author LENOVO
 */
public class MaterialUnidadMedida extends JDialog {

    /**
     * Creates new form MaterialUnidadMedida
     */
    public MaterialUnidadMedida(Frame parent, boolean modal) {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Porfavor, Seleccione una unidad de medida");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MaterialUnidadMedida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MaterialUnidadMedida dialog = new MaterialUnidadMedida(new javax.swing.JFrame(), true);
