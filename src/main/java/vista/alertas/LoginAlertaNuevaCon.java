 ...
 * @author EQUIPO
 */
public class LoginAlertaNuevaCon extends javax.swing.JDialog {
    

    /**
     * Creates new form espacio_alertga
     */
    public LoginAlertaNuevaCon(Frame parent, boolean modal, String error, String todos_los_campos_son_obligatorios) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Error,  Ingrese porfavor una nueva contraseña");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginAlertaNuevaCon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LoginAlertaNuevaCon dialog = new LoginAlertaNuevaCon(new javax.swing.JFrame(), true, "Error", "Todos los campos son obligatorios");
