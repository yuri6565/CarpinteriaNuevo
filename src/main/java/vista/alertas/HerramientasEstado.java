 ...
 * @author LENOVO
 */
public class HerramientasEstado extends JDialog {

    public HerramientasEstado(Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Porfavor, seleccione un estado de la herramienta");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HerramientasEstado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                HerramientasEstado dialog = new HerramientasEstado(new javax.swing.JFrame(), true);
