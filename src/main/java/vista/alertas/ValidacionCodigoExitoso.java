 ...
 * @author EQUIPO
 */
public class ValidacionCodigoExitoso extends JDialog {

    public ValidacionCodigoExitoso() {
  ...
  // Agregar KeyListener para detectar la tecla Enter
      ...
      public ValidacionCodigoExitoso(Frame parent, boolean isEmpty) {
    ...
    private void initComponents() {
        ...
        jPanel3.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 530, 80));
        ...
        jPanel3.add(btnCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 200, 130, -1));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 0, 21)); // NOI18N
        jLabel3.setText("Código de verificación enviado a tu correo");
        jPanel3.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 130, 400, 30));
...
public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            ValidacionCodigoExitoso dialog = new ValidacionCodigoExitoso();
