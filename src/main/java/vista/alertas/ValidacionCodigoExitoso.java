 ...
 * @author EQUIPO
 */
public class ValidacionCodigoExitoso extends javax.swing.JDialog {
     ...
     * @param parent
     */
    public ValidacionCodigoExitoso(Frame parent, boolean modal, String éxito, String datos_guardados_correctamente) {
           super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 180, 70, 40));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel3.setText("Código de verificación enviado a tu correo");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 120, 360, 30));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ValidacionCodigoExitoso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ValidacionCodigoExitoso dialog = new ValidacionCodigoExitoso(new javax.swing.JFrame(), true, "\u00c9xito", "Datos guardados correctamente");
