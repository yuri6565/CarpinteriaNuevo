 ...
 * @author LENOVO
 */
public class ErrorcrearProveedor extends JDialog {

    /**
     * Creates new form AlertaNoVacio
     */
    public ErrorcrearProveedor(Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Upss hubo un error al crear proveedor");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ErrorcrearProveedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ErrorcrearProveedor dialog = new ErrorcrearProveedor(new javax.swing.JFrame(), true);
