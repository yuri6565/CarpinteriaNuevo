 ...
 * @author LENOVO
 */
public class AlertaNoVacio extends JDialog {

    /**
     * Creates new form AlertaNoVacio
     */
    public AlertaNoVacio(Frame parent, boolean modal) {
        super(parent, modal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlertaNoVacio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AlertaNoVacio dialog = new AlertaNoVacio(new javax.swing.JFrame(), true);
