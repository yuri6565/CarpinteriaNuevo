 ...
 * @author EQUIPO
 */
public class AlertaRestablecer extends JDialog {

    public AlertaRestablecer() {
  ...
  // Agregar KeyListener para detectar la tecla Enter
      ...
      public AlertaRestablecer(Frame parent, boolean isEmpty) {
...
public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            AlertaRestablecer dialog = new AlertaRestablecer();
