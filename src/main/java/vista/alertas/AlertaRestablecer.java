 ...
 * @author EQUIPO
 */
public class AlertaRestablecer extends javax.swing.JDialog {
    

    /**
     * Creates new form espacio_alertga
     */
    public AlertaRestablecer(Frame parent, boolean modal, String error, String todos_los_campos_son_obligatorios) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Error,  ingrese porfavor su correo electronico!!!!!!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlertaRestablecer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AlertaRestablecer dialog = new AlertaRestablecer(new javax.swing.JFrame(), true, "Error", "Todos los campos son obligatorios");
