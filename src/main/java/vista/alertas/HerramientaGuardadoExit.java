 ...
 * @author LENOVO
 */
public class HerramientaGuardadoExit extends JDialog {

    /**
     * Creates new form MaterialActualizadoAler
     */
    public HerramientaGuardadoExit(Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Herramienta Guardada Exitosamente");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HerramientaGuardadoExit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                HerramientaGuardadoExit dialog = new HerramientaGuardadoExit(new javax.swing.JFrame(), true);
