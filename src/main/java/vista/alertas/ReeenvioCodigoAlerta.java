 ...
 * @author EQUIPO
 */
public class ReeenvioCodigoAlerta extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public ReeenvioCodigoAlerta(Frame parent, boolean modal, String éxito, String datos_guardados_correctamente) {
    super(parent, modal);
    initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 110, 380, -1));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ReeenvioCodigoAlerta dialog = new ReeenvioCodigoAlerta(new javax.swing.JFrame(), true, "\u00c9xito", "Datos guardados correctamente");
