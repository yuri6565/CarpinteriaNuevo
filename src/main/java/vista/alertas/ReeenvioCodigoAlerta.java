 ...
 * @author EQUIPO
 */
public class ReeenvioCodigoAlerta extends JDialog {

    public ReeenvioCodigoAlerta() {
...
public ReeenvioCodigoAlerta(Frame parent, boolean isEmpty) {
    ...
    private void initComponents() {
        ...
        jPanel3.add(btnCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 190, 130, -1));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 0, 21)); // NOI18N
        jLabel3.setText("Código reenviado correctamente a tu correo");
        jPanel3.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 130, 430, -1));
...
public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            ReeenvioCodigoAlerta dialog = new ReeenvioCodigoAlerta();
