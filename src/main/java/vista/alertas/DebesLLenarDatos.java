 ...
 * @author LENOVO
 */
public class DebesLLenarDatos extends JDialog {

    /**
     * Creates new form AlertaNoVacio
     */
    public DebesLLenarDatos(Frame parent, boolean modal) {
        super(parent, modal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DebesLLenarDatos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DebesLLenarDatos dialog = new DebesLLenarDatos(new javax.swing.JFrame(), true);
