 ...
 * @author LENOVO
 */
public class MaterialingreseCantidad extends JDialog {

    /**
     * Creates new form MaterialAlerCantidad
     */
    public MaterialingreseCantidad(Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Porfavor, Ingrese la cantidad ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MaterialingreseCantidad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MaterialingreseCantidad dialog = new MaterialingreseCantidad(new javax.swing.JFrame(), true);
