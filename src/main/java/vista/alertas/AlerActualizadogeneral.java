 ...
 * @author LENOVO
 */
public class AlerActualizadogeneral extends JDialog {

    /**
     * Creates new form MaterialActualizadoAler
     */
    public AlerActualizadogeneral(Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Actualizado exitosamente");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlerActualizadogeneral.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AlerActualizadogeneral dialog = new AlerActualizadogeneral(new javax.swing.JFrame(), true);
