 ...
 * @author EQUIPO
 */
public class AlertaCodigoVerificado extends javax.swing.JDialog {
     ...
     * @param parent
     */
    public AlertaCodigoVerificado(Frame parent, boolean modal, String éxito, String datos_guardados_correctamente) {
           super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AlertaCodigoVerificado dialog = new AlertaCodigoVerificado(new javax.swing.JFrame(), true, "\u00c9xito", "Datos guardados correctamente");
