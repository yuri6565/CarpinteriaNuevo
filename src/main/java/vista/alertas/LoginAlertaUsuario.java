 ...
 * @author EQUIPO
 */
public class LoginAlertaUsuario extends JDialog {

    public LoginAlertaUsuario() {
        if (!isVisible()) {
            initComponents();
            setOpacity(0.0f);
  ...
  // Agregar KeyListener para detectar la tecla Enter
    ...
    public LoginAlertaUsuario(Frame parent, boolean isEmpty) {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Error,  Ingrese porfavor su usuario");
...
public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(LoginAlertaUsuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }

        java.awt.EventQueue.invokeLater(() -> {
            LoginAlertaUsuario dialog = new LoginAlertaUsuario();
