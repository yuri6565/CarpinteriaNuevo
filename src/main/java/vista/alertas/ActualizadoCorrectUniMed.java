 ...
 * @author LENOVO
 */
public class ActualizadoCorrectUniMed extends JDialog {

    /**
     * Creates new form MaterialAnadidoCorrect
     */
    public ActualizadoCorrectUniMed(Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Unidad Medida actualizada exitosamente");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ActualizadoCorrectUniMed.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ActualizadoCorrectUniMed dialog = new ActualizadoCorrectUniMed(new javax.swing.JFrame(), true);
