 ...
 * @author LENOVO
 */
public class AlerGuardadoExitgeneral extends JDialog {

    /**
     * Creates new form MaterialActualizadoAler
     */
    public AlerGuardadoExitgeneral(Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Guardado Exitosamente");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlerGuardadoExitgeneral.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AlerGuardadoExitgeneral dialog = new AlerGuardadoExitgeneral(new javax.swing.JFrame(), true);
