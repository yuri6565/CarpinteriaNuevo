 ...
 * @author EQUIPO
 */
public class alertaEliminar1 extends JDialog {
    private boolean confirmed = false;

    public alertaEliminar1(Frame parent, boolean modal, String error, String todos_los_campos_son_obligatorios, String customIconPath) {
        super(parent, modal);
...
public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(alertaEliminar1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }

        java.awt.EventQueue.invokeLater(() -> {
            alertaEliminar1 dialog = new alertaEliminar1(new javax.swing.JFrame(), true, "¿Estás seguro?", "¿Está seguro que desea eliminar este producto?", "/warning-triangle-sign-free-vector-removebg-preview.png");
