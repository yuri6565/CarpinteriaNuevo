 ...
 * @author LENOVO
 */
public class MaterialStockMin extends JDialog {

    public MaterialStockMin(Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Porfavor, Ingrese un stock minimo");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MaterialStockMin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MaterialStockMin dialog = new MaterialStockMin(new javax.swing.JFrame(), true);
