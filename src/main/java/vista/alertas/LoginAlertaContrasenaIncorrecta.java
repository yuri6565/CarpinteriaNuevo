 ...
 * @author EQUIPO
 */
public class LoginAlertaContrasenaIncorrecta extends JDialog {

    public LoginAlertaContrasenaIncorrecta() {
    ...
    public LoginAlertaContrasenaIncorrecta(Frame parent, boolean isEmpty) {
    ...
    private void initComponents() {
        ...
        jPanel4.setPreferredSize(new java.awt.Dimension(530, 260));
        ...
        jLabel1.setText("Error de autenticación");
        ...
        jPanel2.add(rSLabelImage1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 80, 70));

        jPanel4.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 530, 90));
        ...
        jPanel4.add(btnCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 200, 130, -1));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 0, 21)); // NOI18N
        jLabel2.setText("Usuario o contraseña incorrectos, intente de nuevo");
        jPanel4.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 130, -1, -1));

        jEImagePanel1.add(jPanel4, new java.awt.GridBagConstraints());
...
public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(LoginAlertaContrasenaIncorrecta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }

        java.awt.EventQueue.invokeLater(() -> {
            LoginAlertaContrasenaIncorrecta dialog = new LoginAlertaContrasenaIncorrecta();
