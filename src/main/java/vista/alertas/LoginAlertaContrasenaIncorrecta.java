 ...
 * @author EQUIPO
 */
public class LoginAlertaContrasenaIncorrecta extends javax.swing.JDialog {
    

    /**
     * Creates new form espacio_alertga
     */
    public LoginAlertaContrasenaIncorrecta(Frame parent, boolean modal, String error, String todos_los_campos_son_obligatorios) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LoginAlertaContrasenaIncorrecta dialog = new LoginAlertaContrasenaIncorrecta(new javax.swing.JFrame(), true, "Error", "Todos los campos son obligatorios");
