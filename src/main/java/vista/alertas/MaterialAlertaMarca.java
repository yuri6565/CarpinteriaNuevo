 ...
 * @author LENOVO
 */
public class MaterialAlertaMarca extends JDialog {

    /**
     * Creates new form MaterialAlertaMarca
     */
    public MaterialAlertaMarca(Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Porfavor, Seleccione una marca");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MaterialAlertaMarca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MaterialAlertaMarca dialog = new MaterialAlertaMarca(new javax.swing.JFrame(), true);
