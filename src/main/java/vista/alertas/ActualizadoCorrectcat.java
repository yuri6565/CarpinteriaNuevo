 ...
 * @author LENOVO
 */
public class ActualizadoCorrectcat extends JDialog {

    /**
     * Creates new form MaterialAnadidoCorrect
     */
    public ActualizadoCorrectcat(Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Categoria actualizada exitosamente");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ActualizadoCorrectcat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ActualizadoCorrectcat dialog = new ActualizadoCorrectcat(new javax.swing.JFrame(), true);
