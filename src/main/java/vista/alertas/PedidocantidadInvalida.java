 ...
 * @author LENOVO
 */
public class PedidocantidadInvalida extends JDialog {

    /**
     * Creates new form AlertaNoVacio
     */
    public PedidocantidadInvalida(Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Upss cantidad Invalida");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PedidocantidadInvalida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PedidocantidadInvalida dialog = new PedidocantidadInvalida(new javax.swing.JFrame(), true);
