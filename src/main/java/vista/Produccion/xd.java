...
public class MaterialNombre extends JDialog {

    public MaterialNombre(Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Porfavor, Ingrese el nombre del material ");
    ...
    private void btnCancelarActionPerformed(java.awt.event.ActionEvent evt) {                                            
        ...
        public static void main(String args[]) {
            try {
                ...
                java.util.logging.Logger.getLogger(MaterialNombre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
            }

            java.awt.EventQueue.invokeLater(() -> {
                MaterialNombre dialog = new MaterialNombre(null, true);
