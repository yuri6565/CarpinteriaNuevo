...
public class catalogoEditar extends javax.swing.JDialog {
private byte[] imagenBytes;

    /**
     * Creates new form catalogoEditar
     */
    public catalogoEditar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(catalogoEditar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                catalogoEditar dialog = new catalogoEditar(new javax.swing.JFrame(), true);
