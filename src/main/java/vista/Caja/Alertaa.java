...
private boolean opcionConfirmada=false;
    private boolean confirmado;
    /**
     * Creates new form alertaa
     */
    public Alertaa(Frame parent, boolean modal, String confirmar, String desea_guardar_los_datos) {
        super(parent, modal);
        initComponents();
}
    
    
    // Método para establecer si se confirmó
    public void setConfirmado(boolean valor) {
    ...
    // En el actionListener de tus botones:
    ...
    public boolean opcionConfirmada() {
        return this.opcionConfirmada;
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Alertaa dialog = new Alertaa(new javax.swing.JFrame(), true, "Confirmar", "\u00bfDesea guardar los datos?");
