...
private boolean guardado = false;
     ...
     */
    public herramientaEditar(java.awt.Frame parent, boolean modal, HerramientaDatos herramienta) {
        super(parent, modal);
        this.herramienta = herramienta;
        initComponents();
        cargarHerramienta(); // Llamar al método para prellenar los campos
    }
...
// Método para prellenar los campos con los datos del material
    private void cargarHerramienta() {
        if (herramienta != null) {
            ...
            cmbTipo.setSelectedItem(herramienta.getTipo());
            cmbMarca.setSelectedItem(herramienta.getMarca());
            cmbEstado.setSelectedItem(herramienta.getEstado());
 ...
 public HerramientaDatos getHerramienta() {
        return herramienta;
    }
    /**
    ...
    private void initComponents() {
        ...
        jPanel1.add(cmbTipo, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 170, 200, 30));
        ...
        jPanel1.add(cmbMarca, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 170, 200, 30));
        ...
        jPanel1.add(cmbEstado, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 260, -1, 30));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (herramienta != null) {
            ...
            herramienta.setDetalles(detalles);
            herramienta.setImagen(imagenSeleccionada); // Actualizar la imagen
        } else {
